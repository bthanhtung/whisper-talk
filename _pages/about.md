...
<div class="article-post" style="font-family: Merriweather; font-size: 1.1rem;">
  ...
  <p>
    <a class="text-danger">MikeDaDev</a> là blog chia sẻ về công nghệ, lập trình và
  ...
  <p>
    Các bài viết tôi chia sẻ trên <a class="text-danger">MikeDaDev</a> sẽ đi từ
  ...
  <p>
    <a class="text-danger">MikeDaDev</a> 
    luôn mong muốn nhận được sự giúp đỡ của các bạn để cải thiện chất lượng tốt
    hơn.
  </p>

  <p>Mọi thông tin xin hãy liên hệ:</p>
  <p><strong>Gmail: </strong>MikeDaDev@gmail.com</p>
  <p><strong>GitHub：</strong>https://github.com/MikeDaDev</p>

  <p>Nếu bạn muốn đăng lại các bài viết từ blog MikeDaDev, xin tuân thủ:</p>
  <p>
